...
const Navbar = () => {
  return (
    <nav className="   bg-transparent backdrop-blur-md  flex gap-80 items-center w-[80vw]    shadow-xl  fixed rounded-full py-1 px-3 ">
      <div className="">
      <h1 className="tracking-widest text-white px-20 py-5 font-extrabold  text-2xl font-['Montserrat_Alternates']">
